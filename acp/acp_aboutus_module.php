	...
	public function main($id, $mode)
	{
		...
		switch ($mode) {
			...
			case 'tou':
				...
				$this->tpl_name = 'acp_aboutus_tou';
				$this->page_title = 'ACP_ABOUTUS_TOU_SETUP';

				$form_name = 'ABOUTUS_tou';
				add_form_key($form_name);
				$error = '';
			...
			case 'privacy':
				...
				$this->tpl_name = 'acp_aboutus_pp';
				$this->page_title = 'ACP_ABOUTUS_PP_SETUP';

				$form_name = 'ABOUTUS_pp';
				add_form_key($form_name);
				$error = '';
